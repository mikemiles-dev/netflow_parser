...
//! - For multi-source deployments, use `AutoScopedParser` (see Template Management Guide)
//!
...
//!
//! > **⚠️ Breaking Change in v0.7.0:** Packet-based and combined TTL modes have been removed. Only time-based TTL is now supported. See [RELEASES.md](https://github.com/mikemiles-dev/netflow_parser/blob/main/RELEASES.md) for migration guide.
//!
...
//! # let mut parser_mut = parser;
//! let packets = parser_mut.parse_bytes(&buffer);
//! ```
//!
//! #### Bulk Registration
//!
...
//!
//! for result in parser.iter_packets(&data) {
//!     if let Ok(NetflowPacket::IPFix(ipfix)) = result {
