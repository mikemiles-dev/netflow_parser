//! IPFIX type definitions — structs, enums, traits, and nom-derived parsing.
//!
//! This module contains all public data types for the IPFIX protocol. Declarative
...
pub(crate) const DATA_TEMPLATE_IPFIX_ID: u16 = 2;
